...
class AppointmentController extends Controller
{
    ...
    protected function gridLeaveStatusColumn($data,$row)
    {
        ...
        if($data['status']=='Waiting'){
            ...
            $criteria->addCondition('sympton IS NOT NULL');
            $chk= Visit::model()->findByPk(@$data['visit_id'],$criteria);
            if($chk){
                echo TbHtml::labelTb('Continue Consultant');
            }else{
                echo TbHtml::labelTb('Waiting',array('color' => TbHtml::LABEL_COLOR_WARNING));
            }
            //echo TbHtml::labelTb('Consultant');
            //echo TbHtml::labelTb($data['visit_id']);
        }
        //return $status;
    }
