...
<div class="row" id="contact">
    <div class="col-xs-12 widget-container-col ui-sortable">
        ...
        <?php $this->widget('yiiwheels.widgets.grid.WhGridView',array(
            'id'=>'vital-grid',
            'dataProvider'=>$model_vital->getOperationTheater(),
            ...
            'columns'=>array(
                ...
                array('name'=>'operation_name',
                    'header'=> 'Operation Name',
                ),
                array('name'=>'diagnosis',
                    'header'=> 'Diagnosis',
                ),
                array('name'=>'operation_procedure',
                ...
                array(
                    ...
                    'buttons' => array(
                        ...
                        'delete' => array(
                            'label'=>'Delete',
                            'url'=>'Yii::app()->createUrl("admitPatient/delete/",array("id"=>$data["id"],"obj"=>"OperationTheater"))',
                            'options' => array(
...
<div id="div_popup">
    ...
    echo $this->renderpartial("popup/_modal_popup", array(
        ...
        'obj'=>'OperationTheater',
        'getPopupPartial'=>'_operation_theater_popup',
        'getPartial'=>'_operation_theater',
        'admit_id' => @$model_patient_info['id'],
        'patient_id'=>@$model_patient_info['patient_id'],
        'header_popup'=>'Operation Theater',
