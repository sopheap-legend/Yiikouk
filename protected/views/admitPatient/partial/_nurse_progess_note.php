...
<div class="row" id="contact">
    <div class="col-xs-12 widget-container-col ui-sortable">
        ...
        <?php $this->widget('yiiwheels.widgets.grid.WhGridView',array(
            'id'=>'vital-grid',
            'dataProvider'=>$model_vital->getNurseProgessNote(),
            ...
            'columns'=>array(
                ...
                array(
                    ...
                    'buttons' => array(
                        'update' => array(
                            'label'=>'Update',
                            'url'=>'Yii::app()->createUrl("admitPatient/update/",array("id"=>$data["id"],"admit_id"=>$data["admit_id"],"patient_id"=>$data["patient_id"],"obj"=>"NurseProgessNote","popup_form"=>"vital-form","treat_mod"=>"nurse_progess_note","getPartial"=>"_nurse_progess_note","getPopupPartial"=>"_nurse_progess_note_popup"))',
                        ...
                        'delete' => array(
                            'label'=>'Delete',
                            'url'=>'Yii::app()->createUrl("admitPatient/delete/",array("id"=>$data["id"],"obj"=>"NurseProgessNote"))',
                            'options' => array(
...
<div id="div_popup">
    ...
    echo $this->renderpartial("popup/_modal_popup", array(
        ...
        'obj'=>'NurseProgessNote',
        'getPopupPartial'=>'_nurse_progess_note_popup',
        'getPartial'=>'_nurse_progess_note',
        'admit_id' => @$model_patient_info['id'],
        'patient_id'=>@$model_patient_info['patient_id'],
        'header_popup'=>'Nurse Progess Note',
